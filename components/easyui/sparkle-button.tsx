...
interface SparkleProps extends React.HTMLAttributes<HTMLButtonElement> {
  text: string
  size: any
  variant: any
  href?: string
...
const SparkleButton = ({ text, size, variant, href, className, ...props }: SparkleProps) => {
  ...
  const button = (
    <><Button
      className={cn("flex relative gap-1 items-center px-5 py-3 text-sm whitespace-nowrap rounded-full transition-all cursor-pointer duration-250", className)}
  ...
  return (
    <div className="inline-flex justify-center items-center bg-transparent">
